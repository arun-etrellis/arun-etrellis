...
use Testrepository\CustomTable\Api\Data\TableSearchResultsInterfaceFactory;
use Testrepository\CustomTable\Api\TableRepositoryInterface;
use Testrepository\CustomTable\Model\ResourceModel\Table as ResourceTable;
use Testrepository\CustomTable\Model\ResourceModel\Table\CollectionFactory as TableCollectionFactory;
...
class TableRepository implements TableRepositoryInterface
{
    ...
    public function save(
        ...
        $tableData = $this->extensibleDataObjectConverter->toNestedArray(
            $table,
            [],
            \Testrepository\CustomTable\Api\Data\TableInterface::class
        );
